def inverter_generate(filename, use_finfet, use_technology):
	...
	if not use_finfet :
		...
		spice_file.write("XMNDOWN n_out n_in n_gnd n_gnd lvtnch L=gate_length W=Wn ")
		...
		spice_file.write("XMPUP n_out n_in n_vdd n_vdd lvtpch L=gate_length W=Wp ")
		...
		spice_file.write("XMNDOWN n_out n_in n_gnd n_gnd hvtnch  L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP n_out n_in n_vdd n_vdd hvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wp*trans_diffusion_length AD=Wp*trans_diffusion_length PS=Wp+2*trans_diffusion_length PD=Wp+2*trans_diffusion_length\n")
		spice_file.write(".ENDS\n\n\n")
		...
		if use_technology == "MTJ":
			...
			spice_file.write("XMNDOWN n_out n_in n_gnd n_gnd hvtnch_mtj L=gate_length W=Wn ")
			spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
			spice_file.write("XMPUP n_out n_in n_vdd n_vdd hvtpch_mtj L=gate_length W=Wp ")
			spice_file.write("AS=Wp*trans_diffusion_length AD=Wp*trans_diffusion_length PS=Wp+2*trans_diffusion_length PD=Wp+2*trans_diffusion_length\n")
			spice_file.write(".ENDS\n\n\n")
	else :
		spice_file.write("******************************************************************************************\n")
		...
		spice_file.write("XMNDOWN n_out n_in n_gnd n_gnd lvtnch L=gate_length nfin=Wn ")
		...
		spice_file.write("XMPUP n_out n_in n_vdd n_vdd lvtpch L=gate_length nfin=Wp ")
		...
		spice_file.write("XMNDOWN n_out n_in n_gnd n_gnd hvtnch  L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPUP n_out n_in n_vdd n_vdd hvtpch L=gate_length nfin=Wp ")
		spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write(".ENDS\n\n\n")
		...
		if use_technology == "MTJ":
			...
			spice_file.write("XMNDOWN n_out n_in n_gnd n_gnd hvtnch_mtj L=gate_length nfin=Wn ")
			spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
			spice_file.write("XMPUP n_out n_in n_vdd n_vdd hvtpch_mtj L=gate_length nfin=Wp ")
			spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
			spice_file.write(".ENDS\n\n\n")
...
def lvl_shifter_generate(filename, use_finfet):
	...
	spice_file.write("XMNDOWN n_out n_in_n n_gnd n_gnd lvtnch L=gate_length W=Wn ")
	spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
	spice_file.write("XMPUP n_out n_in_p n_vdd n_vdd lvtpch L=gate_length W=Wp ")
	spice_file.write("AS=Wp*trans_diffusion_length AD=Wp*trans_diffusion_length PS=Wp+2*trans_diffusion_length PD=Wp+2*trans_diffusion_length\n")
	spice_file.write(".ENDS\n\n\n")	
...
def nand2_generate(filename, use_finfet):
	...
	if not use_finfet :
		...
		spice_file.write("XMNDOWN2 n_out n_vdd n_z n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMNDOWN1 n_z n_in n_gnd n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP1 n_out n_vdd n_vdd n_vdd lvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP2 n_out n_in n_vdd n_vdd lvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write(".ENDS\n\n\n")
		...
		spice_file.write("XMNDOWN2 n_out n_in1 n_z n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMNDOWN1 n_z n_in2 n_gnd n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP1 n_out n_in1 n_vdd n_vdd lvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP2 n_out n_in2 n_vdd n_vdd lvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write(".ENDS\n\n\n")
		...
		spice_file.write("XMNDOWN2 n_out n_in1 n_gnd n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMNDOWN1 n_out n_in2 n_gnd n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP1 n_out n_in1 n_z n_vdd lvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP2 n_z n_in2 n_vdd n_vdd lvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write(".ENDS\n\n\n")		
	else :
		spice_file.write("******************************************************************************************\n")
		...
		spice_file.write("XMNDOWN2 n_out n_vdd n_z n_gnd lvtnch L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMNDOWN1 n_z n_in n_gnd n_gnd lvtnch L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPUP1 n_out n_vdd n_vdd n_vdd lvtpch L=gate_length nfin=Wp ")
		spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPUP2 n_out n_in n_vdd n_vdd lvtpch L=gate_length nfin=Wp ")
		spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write(".ENDS\n\n\n")
...
def nand2_generate_lp(filename, use_finfet):
	...
	if not use_finfet :
		...
		spice_file.write("XMNDOWN2 n_out n_vdd n_z n_gnd hvtnch  L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMNDOWN1 n_z n_in n_gnd n_gnd hvtnch  L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP1 n_out n_vdd n_vdd n_vdd hvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP2 n_out n_in n_vdd n_vdd hvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write(".ENDS\n\n\n")
	else :
		spice_file.write("******************************************************************************************\n")
		...
		spice_file.write("XMNDOWN2 n_out n_vdd n_z n_gnd hvtnch  L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMNDOWN1 n_z n_in n_gnd n_gnd hvtnch  L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPUP1 n_out n_vdd n_vdd n_vdd hvtpch L=gate_length nfin=Wp ")
		spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPUP2 n_out n_in n_vdd n_vdd hvtpch L=gate_length nfin=Wp ")
		spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write(".ENDS\n\n\n")
...
def nand3_generate(filename, use_finfet):
	...
	if not use_finfet :
		...
		spice_file.write("XMNDOWN2 n_out n_vdd n_z n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMNDOWN1 n_z n_vdd n_z2 n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMNDOWN0 n_z2 n_in n_gnd n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP0 n_out n_vdd n_vdd n_vdd lvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP1 n_out n_vdd n_vdd n_vdd lvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP2 n_out n_in n_vdd n_vdd lvtpch L=gate_length W=Wp ")
		...
		spice_file.write("XMNDOWN3 n_out n_in1 n_z n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMNDOWN2 n_z n_in2 n_y n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMNDOWN1 n_y n_in3 n_gnd n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		...
		spice_file.write("XMPUP2 n_out n_in2 n_vdd n_vdd lvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP3 n_out n_in3 n_vdd n_vdd lvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write(".ENDS\n\n\n")		
	else :
		spice_file.write("******************************************************************************************\n")
		...
		spice_file.write("XMNDOWN2 n_out n_vdd n_z n_gnd lvtnch L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMNDOWN1 n_z n_vdd n_z2 n_gnd lvtnch L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMNDOWN0 n_z2 n_in n_gnd n_gnd lvtnch L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPUP0 n_out n_vdd n_vdd n_vdd lvtpch L=gate_length nfin=Wp ")
		spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPUP1 n_out n_vdd n_vdd n_vdd lvtpch L=gate_length nfin=Wp ")
		spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPUP2 n_out n_in n_vdd n_vdd lvtpch L=gate_length nfin=Wp ")
...
def nand3_generate_lp(filename, use_finfet):
	...
	if not use_finfet :
		...
		spice_file.write("XMNDOWN2 n_out n_vdd n_z n_gnd hvtnch  L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMNDOWN1 n_z n_vdd n_z2 n_gnd hvtnch  L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMNDOWN0 n_z2 n_in n_gnd n_gnd hvtnch  L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP0 n_out n_vdd n_vdd n_vdd hvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP1 n_out n_vdd n_vdd n_vdd hvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPUP2 n_out n_in n_vdd n_vdd hvtpch L=gate_length W=Wp ")
		...
		spice_file.write("XMNDOWN2 n_out n_vdd n_z n_gnd hvtnch  L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMNDOWN1 n_z n_vdd n_z2 n_gnd hvtnch  L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMNDOWN0 n_z2 n_in n_gnd n_gnd hvtnch  L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPUP0 n_out n_vdd n_vdd n_vdd hvtpch L=gate_length nfin=Wp ")
		spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPUP1 n_out n_vdd n_vdd n_vdd hvtpch L=gate_length nfin=Wp ")
		spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPUP2 n_out n_in n_vdd n_vdd hvtpch L=gate_length nfin=Wp ")
...
def rest_generate(filename, use_finfet):
	...
	if not use_finfet :
		...
		spice_file.write("XMPREST n_pull n_gate n_vdd n_vdd lvtpch L=gate_length*rest_length_factor W=Wp ")
		spice_file.write("AS=Wp*trans_diffusion_length AD=Wp*trans_diffusion_length PS=Wp+2*trans_diffusion_length PD=Wp+2*trans_diffusion_length\n")
		spice_file.write(".ENDS\n\n\n")
	else :
		spice_file.write("******************************************************************************************\n")
		...
		spice_file.write("XMPREST n_pull n_gate n_vdd n_vdd lvtpch L=gate_length*rest_length_factor nfin=Wp ")
		spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write(".ENDS\n\n\n")   
...
def ptran_generate(filename, use_finfet):
	...
	if not use_finfet :
		...
		spice_file.write("XMNPASS n_in n_gate n_out n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write(".ENDS\n\n\n")   
	else :
		spice_file.write("******************************************************************************************\n")
		...
		spice_file.write("XMNPASS n_in n_gate n_out n_gnd lvtnch L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write(".ENDS\n\n\n")   
...
def ptran_pmos_generate(filename, use_finfet):
	...
	if not use_finfet :
		...
		spice_file.write("XMPPASS n_in n_gate n_out n_vdd lvtpch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write(".ENDS\n\n\n")   
	else :
		spice_file.write("******************************************************************************************\n")
		...
		spice_file.write("XMPPASS n_in n_gate n_out n_vdd lvtpch L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write(".ENDS\n\n\n")   
...
def tgate_generate(filename, use_finfet):
	...
	if not use_finfet :
		...
		spice_file.write("XMNTGATE n_in n_gate_nmos n_out n_gnd lvtnch L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPTGATE n_in n_gate_pmos n_out n_vdd lvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wp*trans_diffusion_length AD=Wp*trans_diffusion_length PS=Wp+2*trans_diffusion_length PD=Wp+2*trans_diffusion_length\n")
		spice_file.write(".ENDS\n\n\n")   
	else :
		spice_file.write("******************************************************************************************\n")
		...
		spice_file.write("XMNTGATE n_in n_gate_nmos n_out n_gnd lvtnch L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPTGATE n_in n_gate_pmos n_out n_vdd lvtpch L=gate_length nfin=Wp ")
		spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write(".ENDS\n\n\n")
...
def tgate_generate_lp(filename, use_finfet):
	...
	if not use_finfet :
		...
		spice_file.write("XMNTGATE n_in n_gate_nmos n_out n_gnd hvtnch  L=gate_length W=Wn ")
		spice_file.write("AS=Wn*trans_diffusion_length AD=Wn*trans_diffusion_length PS=Wn+2*trans_diffusion_length PD=Wn+2*trans_diffusion_length\n")
		spice_file.write("XMPTGATE n_in n_gate_pmos n_out n_vdd hvtpch L=gate_length W=Wp ")
		spice_file.write("AS=Wp*trans_diffusion_length AD=Wp*trans_diffusion_length PS=Wp+2*trans_diffusion_length PD=Wp+2*trans_diffusion_length\n")
		spice_file.write(".ENDS\n\n\n")   
	else :
		spice_file.write("******************************************************************************************\n")
		...
		spice_file.write("XMNTGATE n_in n_gate_nmos n_out n_gnd hvtnch  L=gate_length nfin=Wn ")
		spice_file.write("ASEO=Wn*min_tran_width*trans_diffusion_length ADEO=Wn*min_tran_width*trans_diffusion_length PSEO='Wn*(min_tran_width+2*trans_diffusion_length)' PDEO='Wn*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write("XMPTGATE n_in n_gate_pmos n_out n_vdd hvtpch L=gate_length nfin=Wp ")
		spice_file.write("ASEO=Wp*min_tran_width*trans_diffusion_length ADEO=Wp*min_tran_width*trans_diffusion_length PSEO='Wp*(min_tran_width+2*trans_diffusion_length)' PDEO='Wp*(min_tran_width+2*trans_diffusion_length)'\n")
		spice_file.write(".ENDS\n\n\n")
